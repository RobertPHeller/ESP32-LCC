...
injecting power into the LCC bus. Above the LCC power terminal blocks are a
...
outputs (two banks of 8) and there is a two position terminal block to 
provide (optional) external power for the signal lamps.  These terminal blocks 
are on the right side of the board.  The boards can be built to be either for 
