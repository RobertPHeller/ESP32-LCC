...
/// @file P9WiFiLCCTraction_Sound_Sound.cpp
...
namespace P9WiFiLCCTraction_Sound_Sound {
...
void app_main()
{
    ...
    LOG(INFO, "[P9WiFiLCCTraction_Sound_Sound] about to start the PhysicalTrainNode");
    ...
    LOG(INFO, "[P9WiFiLCCTraction_Sound_Sound] MemoryConfigClient done.");
    P9WiFiLCCTraction_Sound_Sound::FactoryResetHelper factory_reset_helper;
    LOG(INFO, "[P9WiFiLCCTraction_Sound_Sound] FactoryResetHelper done.");
    reboothelpers::DelayRebootHelper delayed_reboot(stack.service());
    LOG(INFO, "[P9WiFiLCCTraction_Sound_Sound] DelayRebootHelper done.");
    healthmonitor::HealthMonitor health_mon(stack.service());
    LOG(INFO, "[P9WiFiLCCTraction_Sound_Sound] HealthMonitor done.");
    ...
    LOG(INFO, "[P9WiFiLCCTraction_Sound_Sound] WiFi started");
