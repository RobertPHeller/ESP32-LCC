...
public:
  Adafruit_ST7735(int8_t cs, const Gpio *dc, const Gpio *rst);
  ...
  void initB(openmrn_arduino::Esp32SPI*spi);          // for ST7735B displays
  void initR(openmrn_arduino::Esp32SPI*spi,uint8_t options = INITR_GREENTAB); // for ST7735R
