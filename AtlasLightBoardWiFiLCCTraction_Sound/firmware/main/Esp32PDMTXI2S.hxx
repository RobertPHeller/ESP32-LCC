...
#ifndef __ESP32PDMTXI2S_HXX
#define __ESP32PDMTXI2S_HXX
...
class Esp32PDMTXI2S : private Atomic
{
    /// Constructor.
    ///
    /// @param path Base path to use for I2S pdm drivers.
    Esp32PDMTXI2S(const char * const path = "/dev/i2s_pdm");
...
private:
    ...
    struct i2s_device_t
    {
        /// I2S Handle that this file handle will use.
