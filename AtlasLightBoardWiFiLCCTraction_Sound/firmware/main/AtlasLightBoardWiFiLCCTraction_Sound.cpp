...
/// @file AtlasLightBoardWiFiLCCTraction_Sound.cpp
 ...
 * 
 * @image html AtlasLightBoardWiFiLCCTraction_Sound_Top3D.png
 * 
...
AtlasLightBoardWiFiLCCTraction_Sound::ConfigDef cfg(0);
...
namespace AtlasLightBoardWiFiLCCTraction_Sound {
...
void app_main()
{
    ...
    LOG(INFO, "[AtlasLightBoardWiFiLCCTraction_Sound] about to start the PhysicalTrainNode");
    ...
    LOG(INFO, "[AtlasLightBoardWiFiLCCTraction_Sound] MemoryConfigClient done.");
    AtlasLightBoardWiFiLCCTraction_Sound::FactoryResetHelper factory_reset_helper;
    LOG(INFO, "[AtlasLightBoardWiFiLCCTraction_Sound] FactoryResetHelper done.");
    reboothelpers::DelayRebootHelper delayed_reboot(stack.service());
    LOG(INFO, "[AtlasLightBoardWiFiLCCTraction_Sound] DelayRebootHelper done.");
    healthmonitor::HealthMonitor health_mon(stack.service());
    LOG(INFO, "[AtlasLightBoardWiFiLCCTraction_Sound] HealthMonitor done.");
