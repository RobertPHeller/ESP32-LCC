...
using ServoConsumers = openlcb::RepeatedGroup<openlcb::ServoConsumerConfig, 16>;
using Ext0PC = openlcb::RepeatedGroup<openlcb::PCConfig, 16>;
...
CDI_GROUP_ENTRY(ext0_pc, Ext0PC, Name("IO Expansion Board with MCP23017 Lines"),RepName("Line"));
