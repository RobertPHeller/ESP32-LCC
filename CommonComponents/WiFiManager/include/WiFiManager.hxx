...
#ifndef __WIFIMANAGER_HXX
#define __WIFIMANAGER_HXX
...
public:
    ...
    WiFiManager(const char *station_ssid
...
private:
    ...
    public:
        ...
        UplinkNotifiable(WiFiManager *parent) : parent_(parent)
        {
        }
    ...
    DISALLOW_COPY_AND_ASSIGN(WiFiManager);
};

#endif // __WIFIMANAGER_HXX
