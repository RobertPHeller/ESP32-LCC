...
*/
/**************************************************************************/
void Adafruit_ST7735::initB(openmrn_arduino::Esp32SPI*spi) {
  commonInit(spi,Bcmd);
  setRotation(0);
}
...
*/
/**************************************************************************/
void Adafruit_ST7735::initR(openmrn_arduino::Esp32SPI*spi,uint8_t options) {
  commonInit(spi,Rcmd1);
  if (options == INITR_GREENTAB) {
    ...
    _colstart = 26;
    _rowstart = 1;
    invertOnCommand_ = ST77XX_INVOFF;
    invertOffCommand_ = ST77XX_INVON;
  } else {
