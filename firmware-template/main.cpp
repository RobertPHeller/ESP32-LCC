...
void app_main()
{
    ...
    LOG(INFO, "[@PROJECT@] about to start the PhysicalTrainNode");
    ...
    LOG(INFO, "[@PROJECT@] MemoryConfigClient done.");
    @PROJECT@::FactoryResetHelper factory_reset_helper;
    LOG(INFO, "[@PROJECT@] FactoryResetHelper done.");
    reboothelpers::DelayRebootHelper delayed_reboot(stack.service());
    LOG(INFO, "[@PROJECT@] DelayRebootHelper done.");
    healthmonitor::HealthMonitor health_mon(stack.service());
    LOG(INFO, "[@PROJECT@] HealthMonitor done.");
